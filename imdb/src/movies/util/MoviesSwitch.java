	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MoviesPackage.ACTRESS: {
				...
				if (result == null) result = caseElement(actress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoviesPackage.COUPLE: {
				...
				if (result == null) result = caseElement(couple);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoviesPackage.MOVIE: {
				...
				if (result == null) result = caseElement(movie);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case MoviesPackage.CLIQUE: {
				...
				if (result == null) result = caseElement(clique);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoviesPackage.ROOT_ELEMENT: {
				RootElement rootElement = (RootElement)theEObject;
				T result = caseRootElement(rootElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MoviesPackage.ELEMENT: {
